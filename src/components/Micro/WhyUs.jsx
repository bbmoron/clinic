      ...
      <BrowserView>
        <ConsultOfferWrap>
          <ConsultOfferForm>
            ...
            <BlueDesc>За счет сужения направления деятельности мы лечим максимально эффективно то, что действительно умеем, а получаете ощутимый результат.</BlueDesc>
      ...
      <MobileView>
        <ConsultOfferWrapMob>
          <ConsultOfferFormMob>
            ...
            <BlueDescMob>За счет сужения направления деятельности мы лечим максимально эффективно то, что действительно умеем, а получаете ощутимый результат.</BlueDescMob>
