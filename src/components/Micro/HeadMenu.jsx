    ...
    <>
      <BrowserView>
        <MenuWrap>
          ...
          <UnderMenuWrap>
            <UnderMenu>
              <p style={{ padding: 0, margin: 0, marginTop: '4px' }}><Black>Все от правильного диагноза до лечения</Black></p>
        ...
        <MenuWrap>
          <MenuMob>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: 0, margin: 0 }}>
              <a href="tel:+78126792388" style={{ padding: 0, margin: 0, textDecoration: 'none', color: 'black', fontSize: '18px' }}>+7(812) 679 2388</a>
